import { ArrowLeft, Cpu, Lock, ArrowRight, User, Mail, CheckCircle, RefreshCcw } from 'lucide-react';
                ...
                <div className="w-full max-w-lg animate-in fade-in zoom-in-95 duration-500">
                    <Card className="bg-neutral-900/50 border-neutral-800 p-8 text-center">
                        ...
                        <p className="text-neutral-400 mb-6">
                            Your registration was successful. You need to verify your email address before continuing.
                        </p>
                        <div className="bg-neutral-950/50 border border-neutral-800 rounded-xl p-4 mb-8 flex items-center justify-center gap-3">
        ...
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-lg animate-in fade-in zoom-in-95 duration-500">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-white mb-2">Welcome to Vayload Registry</h2>
                    <p className="text-neutral-400">The official plugins registry for Vayload</p>
                </div>
                    ...
                    <div className="space-y-4">
                        {!isLogin && (
                            <div className="space-y-1.5">
                                <Label className="flex px-2">Username</Label>
                                <div className="relative">
                                    <User size={16} className="absolute left-4 top-3 text-neutral-500" />
                                    <Input
                                        type="text"
                        ...
                        <div className="space-y-1.5">
                            <Label className="flex px-2">Email</Label>
                            <div className="relative">
                                <Mail size={16} className="absolute left-4 top-3 text-neutral-500" />
                                <Input
                                    type="email"
                                    placeholder="Email"
                                    name="email"
                        ...
                        <div className="space-y-1.5">
                            <Label className="flex px-2">Password</Label>
                            <div className="relative">
                                <Lock size={16} className="absolute left-4 top-3 text-neutral-500" />
                                <Input
                                    type="password"
                                    placeholder="●●●●●●●●●●●●●●●●●●●●●"
                                    name="password"
