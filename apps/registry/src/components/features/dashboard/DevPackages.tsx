	...
	return (
		<div className="animate-in fade-in duration-500">
			<div className="border-b border-neutral-800 pb-4 mb-8 flex justify-between items-end">
				...
				<Button variant="secondary" className="h-10 px-6" onClick={() => setIsUploadModalOpen(true)}>
			...
			<UploadPluginModal isOpen={isUploadModalOpen} onClose={() => setIsUploadModalOpen(false)} />
		</div>
	);
};
