...
export const UploadPluginModal = ({ isOpen, onClose }: UploadPluginModalProps) => {
			...
			<div className="space-y-6">
				{!file ? (
					...
					>
						...
						<h3 className="text-white font-semibold mb-2">Select ZIP Archive</h3>
						<p className="text-neutral-500 text-sm max-w-xs mx-auto">
							Drag and drop your plugin archive or click to browse. Only .zip files are supported.
						</p>
					</div>
				) : (
				...
				<div className="bg-neutral-950/50 rounded-xl p-4 border border-neutral-800">
					...
					<ul className="text-xs text-neutral-400 space-y-1.5">
						<li className="flex items-start gap-2">
							...
							Must contain a valid `manifest.json` file.
						</li>
						<li className="flex items-start gap-2">
							<div className="w-1.5 h-1.5 rounded-full bg-orange-500 mt-1" />
